...
const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return <div className="flex flex-col items-center justify-center py-8 md:py-16 px-4 animate-slide-down">
      ...
      <div className="glass rounded-full p-5 md:p-6 mb-4">
        <img src="/icons/cart-icon.png" alt="Shopping Cart" className="h-10 w-10 md:h-12 md:w-12" />
      </div>
      ...
      <Button onClick={onAddItem} className="glass border-none bg-primary w-full sm:w-auto text-white">
